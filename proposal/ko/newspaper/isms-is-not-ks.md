...
하지만 정보보안은 다르다. 정보보안은 고정된 제품의 품질을 확인하는 일이 아니라, 계속 변하는 공격자와 실시간으로 맞서는 운영의 문제다. 오늘 통과한 점검표가 내일의 공격까지 막아주지는 않는다. 어제 없던 제로데이, 변형 공격, 정상 계정을 노리는 크리덴셜 스터핑 같은 공격은 기존 인증 항목만으로는 설명되지 않는다. 같은 시스템이라도 공격자 전술이 바뀌면 위험 수준은 순식간에 달라진다.
