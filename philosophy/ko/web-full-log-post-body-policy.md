> **요약 한눈에 보기**
> 1. 지금 공격의 출발점은 방화벽이 아니라 **업무·민원·API 같은 웹 서비스**입니다.  
> 2. 그런데 여전히 많은 기관이 **URL·상태코드만 남기고, POST 본문·파라미터 로그는 버리고** 있습니다.  
> 3. 이 때문에 사고가 나도 “접속은 있었지만, **무슨 내용을 보냈는지는 모르는**” 상태가 반복됩니다.  
> 4. **웹 본문(POST Body)까지 포함한 전체 웹 로그**를 남기고 분석하는 것이, 제로데이·계정탈취·웹쉘·API 남용을 막는 **가장 현실적인 해법**입니다.  
> 5. 이는 2025년 국감에서 지적된 “**로그 부재로 인한 원인 불명**” 문제를 끊어내기 위한, 우리나라 디지털 서비스의 **새로운 최저 보안 기준**이 되어야 합니다.
