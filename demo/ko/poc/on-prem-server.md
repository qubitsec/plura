...
* CPU: **8 vCPU**
* 메모리: **32~64GB RAM**
* 디스크: **500GB~1TB SSD**(로그/인덱스/메타 포함)
* 네트워크: 1GbE (수집 전용 VLAN 권장)
* OS: Rocky Linux 8/9

**확장형(POST-body/부하 테스트 포함 시)**
...
* 인프라/업무 서버 **5MB/일 × 300대 = 1.5GB/일**
* 보존 30일: **~45GB(raw)** → 압축 2:1 → **~22.5GB**
* 보존 90일: **~135GB(raw)** → 압축 후 **~67.5GB**
* 인덱스·여유(≈×1.5) 반영 → **30일 기준 총 ~35GB, 90일 기준 총 ~100GB 내외**
* 실운영 여유 및 돌발 증가를 고려해 **최소 500GB 이상** 권장
* **대용량 POST-body 시나리오** 수행 시 1~2TB 권장
