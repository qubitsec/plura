...
👉 [PowerShell 스크립트](https://github.com/QubitSecurity/EDR/blob/main/Windows/Event-Channel/count-logs.md)
...
이러한 **제1종 오류(Type I Error)가 구조적으로 발생하지 않는다.**
...
✔ 본 테스트로
**보안 가시성과 대응 가능성의 차이를 명확히 보여주는 실험**으로 제안됨
