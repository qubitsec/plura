...
| 분석 범위 | 웹, 호스트 이벤트 개별 확인 | 웹·호스트 보안·포렌식 데이터 통합 상관분석 |
| 대응 방식 | 탐지 후 담당자 확인 및 수동 조치 중심 | 자동 IP 차단 및 대응 자동화 |
| 침해 분석 | 사고 이후 증적 확인 및 원인 분석 부담 | 탐지 시점부터 자동 포렌식 연계 |
| 운영 효율 | 반복 공격 분석·대응에 운영 부담 발생 | AI 분석과 자동화 대응으로 보안 운영 효율 향상 |
| SOC 운영/보고 | 보안 이벤트 분석 및 보고서 작성 수작업 | AI 기반 이벤트 분석·요약 및 SOC 보고 지원 |
