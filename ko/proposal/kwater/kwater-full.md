...
| 기술자료 등급·분류체계 구축 | 기업별 규정과 문서생명주기를 기반으로 한 별도 관리사업 |
| 내부자 감시·행위평가 | 인사·직무·업무맥락과 법률·노무 검토가 필요한 별도 영역 |
...
| 기업별 맞춤 애플리케이션 개발 | 표준 인터페이스를 벗어나는 개발은 기간·예산을 별도 산정 |
...
세 사업은 역할이 다르며, 본 제안의 성공을 위해서는 사이버 침해 대응범위를 문서보안과 내부자 관리영역으로 확장하지 않아야 합니다.
...
이는 표준 사이버 침해 대응 서비스가 아니라 146개의 기업별 관리 SI 사업입니다.
...
OT 내부에 대한 직접 통제는 안전성·가용성 검토와 운영부서 승인 후 별도 고도화사업으로 추진합니다.
...
문서보안, 기술자료 분류, 내부자 관리, 직무권한, 인사·결재와 업무프로세스 통제는 협력기업마다 구조가 달라 표준화가 어렵고, 기업별 시스템통합과 더 큰 비용이 필요합니다. 이를 외부 침입 대응사업에 함께 포함하면 사업의 핵심이 흐려지고 146개 협력기업의 구축과 운영이 지연될 수 있습니다.
