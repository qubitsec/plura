...
| No. | 구분 | 지원내용 |
| ---: | --- | --- |
| 1 | 외부 공격면 보호 | 인터넷 공개 웹서비스, 외부 접근서비스, 원격접속 경로 |
| 2 | 웹 침입 대응 | WAF, 웹 요청·응답 분석, 변형·제로데이 의심 공격 분석 |
| 3 | 서버 침해 대응 | 로그인, 명령, 프로세스, 파일, 권한변경과 외부통신 분석 |
| 4 | PC 침해 대응 | 악성코드, 랜섬웨어, 의심 프로세스와 자격증명 탈취행위 분석 |
...
| 9 | 공급망 관제 | 국내 24×365 전문 보안관제와 한수원 상향보고 |
...
| 2 | 기술자료 등급·분류체계 구축 | 외부 사이버침입 대응이 아닌 문서분류·보관·승인 관리영역 |
| 3 | 내부자 감시·행위평가 | 외부 공격 대응이 아닌 인사·감사·노무 기반의 내부 업무관리 영역 |
...
| 7 | 기업별 맞춤 애플리케이션 개발 | 표준 침해대응 서비스가 아닌 기업별 애플리케이션 개발영역 |
...
| No. | 사업영역 | 주요 역할 |
| ---: | --- | --- |
| 1 | 보안수준 평가 | 협력기업의 보안통제 구축상태와 개선과제 확인 |
| 2 | 기술정보 보안관리 | 기술자료의 등록·접근·배포·보관 등 생명주기 관리 |
| 3 | 본 사이버 침해 대응사업 | 외부 해커의 웹·서버·PC·계정 공격 탐지·차단·포렌식·복구 |
...
| ---: | --- | --- | --- |
| 1 | 목표 | 제품 구축과 관리수준 개선 | 외부 공격의 탐지·차단·사고대응 |
| 2 | 대상 | 광범위한 정보보안 항목 | 웹·서버·PC·계정·원격접속 공격 |
| 3 | 구축 | 기업별 서로 다른 구성 | 표준 패키지와 공통 정책 |
| 4 | 운영 | 기업별 자체 대응 | 국내 24시간 전문 SOC |
| 5 | 분석 | 제품별 경보 | 여러 협력기업의 공격체인 통합분석 |
| 6 | 사고 | 발생 후 별도 지원 | 실시간 차단·격리·포렌식 |
| 7 | 한수원 가시성 | 정기 자료취합 | 공급망 위험·사고·미조치 상시 확인 |
| 8 | 성과 | 구축수량·교육횟수 | 탐지·통보·차단·복구결과 |
| 9 | 확장성 | 기업별 SI로 확산 어려움 | 146개사 공통 표준 적용 |
...
| No. | 비용영역 | 주요내용 |
| ---: | --- | --- |
| 1 | 진단·온보딩 | 외부 공격면 확인, 자산등록, 에이전트·WAF·로그연계 |
| 2 | 플랫폼·인프라 | 기업별 분리환경, 로그수집·저장·검색·분석 |
| 3 | WAF·EDR·XDR | 웹·서버·PC·계정 공격 탐지·차단 기능 |
| 4 | 24시간 SOC | 공격검증, 위험분류, 기업·한수원 통보 |
| 5 | 사고대응 | 격리·포렌식·영향분석·복구지원 |
| 6 | 교육·실증 | 담당자 교육, 공격시나리오와 대응절차 검증 |
| 7 | 사업관리 | 한수원 대시보드, SLA·KPI·협력기업 이행평가 |
...
| No. | 지원항목 | 표준범위 예시 |
| ---: | --- | --- |
| 1 | 외부 웹서비스 | 인터넷 공개 웹서비스의 WAF·웹 공격 탐지·차단 |
| 2 | 업무용 서버 | 로그인·명령·프로세스·파일·권한·외부통신 분석 |
| 3 | 업무용 PC | 악성코드·랜섬웨어·이상 프로세스 탐지 |
| 4 | 원격접속 | 표준 VPN·관리자·원격접속 로그 연계 |
| 5 | 계정공격 | 브루트포스·크리덴셜 스터핑·탈취계정 탐지 |
| 6 | 통합분석 | 웹·서버·PC·계정 이벤트의 공격체인 상관분석 |
| 7 | 전문관제 | 국내 24×365 SOC의 공격검증·통보·대응지원 |
| 8 | 사고대응 | 차단·격리·자동 포렌식·영향분석·복구지원 |
| 9 | 교육·훈련 | 담당자 교육과 모의 공격·대응점검 |
| 10 | 대시보드·보고 | 기업별 대시보드, 한수원 대시보드, 월간·종합보고 |
...
| 4 | 통제 주권 | 한수원과 협력기업이 계정·정책·보존·반출·삭제를 통제 |
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | P1 긴급 | 침해 진행, 랜섬웨어, C2, 공급망 확산, 대량 외부전송 | SOC 확인 후 15분 이내 | 30분 이내 | 사전 승인범위 즉시, 그 외 60분 이내 협의 |
...
| 4 | 외부노출·취약점 개선 | 20점 | 반복공격 경로와 위험설정의 기술적 개선 |
...
| No. | 차수 | 권고 기업 수 | 주요내용 |
| ---: | --- | ---: | --- |
| 1 | 선행차수 | 30~35개사 | 업종·환경별 대표기업 구축, 표준절차 검증 |
| 2 | 2차 | 35~40개사 | 선행결과 반영, 병렬확산 |
| 3 | 3차 | 35~40개사 | 웹·원격접속·고위험 기업 우선 |
...
| 6 | 공급망 | 다수기업 공통 공격 | 캠페인 단위 분석·보고 |
| 7 | 대응 | P1 기업 통보 | SOC 확인 후 15분 이내 |
| 8 | 대응 | P1 한수원 보고 | SOC 확인 후 30분 이내 |
| 9 | 대응 | 차단·격리·포렌식 | 승인된 절차 정상 수행 |
| 10 | 증거 | 원본로그·사고 타임라인 | 중대사고 확보 |
| 11 | 협조 | 기업 이행점수 | 연속지원 기본 70점 이상 |
| 12 | 배제 | 고의중지·은폐·증거조작 | 중대 배제사유 |
| 13 | 주권 | 국내 저장·관제·대응 | 전 대상 적용 |
| 14 | 후속 | 차년도 상시운영 계획 | 기술·예산·인력안 확정 |
