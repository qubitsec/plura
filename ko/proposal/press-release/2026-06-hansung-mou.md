...
큐비트시큐리티는 클라우드 SaaS 기반 통합 사이버보안 플랫폼 **PLURA-XDR**을 제공하는 AI 사이버보안 전문 기업이다. PLURA-XDR은 WAF, EDR, SIEM, SOAR, 원격보안관제를 하나의 플랫폼에서 통합 제공하며, AI 기반 제로데이 공격 탐지·대응, 크리덴셜 스터핑 공격 자동 대응, 미토스급 AI 해킹 공격 대응 역량을 바탕으로 공격 탐지부터 분석, 대응, 포렌식까지 전주기를 지원한다.
