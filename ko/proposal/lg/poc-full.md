...
특정 해외 보안제품의 탐지정책과 업데이트에만 의존하지 않고, 국내에서 공격 데이터를 축적하며 AI 프롬프트, 탐지 기준, 차단 및 포렌식 체계를 직접 통제할 수 있다는 점이 PLURA-XDR이 제공하는 소버린 사이버시큐리티의 핵심입니다. 향후 LG EXAONE AI와 연계할 경우, 원본 보안 데이터와 AI 판단·대응 체계를 국내에서 통제하는 소버린 AI 사이버시큐리티로 확장할 수 있습니다.
