...
## 기존 보안관제센터와 PLURA-XDR 연동을 통한 본청·하위기관·지역 제조업 통합 보호 방안
...
지자체 담당자에게 설명할 핵심 메시지는 다음 세 가지입니다.
...
flowchart LR
    ...
    subgraph After[PLURA-XDR 연동 후]
        A1["핵심 자산·로그 통합 수집<br><br>AI 기반 요약·위험도 분류<br><br>공격 요청·응답과 계정·서버 행위 연결<br><br>본청·하위기관·위탁기관 통합 가시성 확보<br><br>차단·점검·개인정보보호·감사 보고 근거 확보"]
    end
...
| 6단계 | 공동 대응 체계 정착 | 관제센터, 데이터센터, 서버담당자, 업무부서, 개인정보보호 담당자 협업 운영 | 정기 보고서, 사고 대응 훈련, 개선 과제 |
